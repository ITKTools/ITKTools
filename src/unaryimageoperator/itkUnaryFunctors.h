...
{
  typename itk::InPlaceImageFilter<TInputImage, TOutputImage>::Pointer GetFilter(UnaryFunctorEnum filterType)
  {
    if(filterType == PLUS)
    {
    ...
    {
      typedef itk::UnaryFunctorImageFilter<TInputImage, TOutputImage, 
					  itk::Functor::RPOWER< TArgument> >  FilterType;
      typename FilterType::Pointer filter = FilterType::New();
      return filter.GetPointer();
    }
    ...
    {
      typedef itk::UnaryFunctorImageFilter<TInputImage, TOutputImage, 
					  itk::Functor::LPOWER< TArgument> >  FilterType;
      typename FilterType::Pointer filter = FilterType::New();
      return filter.GetPointer();
    }
