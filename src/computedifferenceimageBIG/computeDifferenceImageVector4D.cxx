...
int ComputeVectorDifferenceImage4D( const std::string &inputPixelComponentType1,
  ...
  const std::string &outputFileName, int inputDimension, int vectorDimension )
{
  ...
  if ( inputDimension == ImageDims )
  {
    ...
    else if ( vectorDimension == 4 )
    {
      /** From unsigned char and unsigned char to something else. */
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned char, unsigned char, double, ImageDims, 4 );

      /** From char and char to something else. */
      callCorrectVectorDifferenceMacro( char, char, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( char, char, double, ImageDims, 4 );

      /** From unsigned short and unsigned short to something else. */
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned short, unsigned short, double, ImageDims, 4 );

      /** From short and short to something else. */
      callCorrectVectorDifferenceMacro( short, short, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( short, short, double, ImageDims, 4 );

      /** From unsigned int and unsigned int to something else. */
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned int, unsigned int, double, ImageDims, 4 );

      /** From int and int to something else. */
      callCorrectVectorDifferenceMacro( int, int, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( int, int, double, ImageDims, 4 );

      /** From unsigned long and unsigned long to something else. */
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( unsigned long, unsigned long, double, ImageDims, 4 );

      /** From long and long to something else. */
      callCorrectVectorDifferenceMacro( long, long, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( long, long, double, ImageDims, 4 );

      /** From float and float to something else. */
      callCorrectVectorDifferenceMacro( float, float, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( float, float, double, ImageDims, 4 );

      /** From double and double to something else. */
      callCorrectVectorDifferenceMacro( double, double, unsigned char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, char, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, unsigned short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, short, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, unsigned int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, int, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, unsigned long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, long, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, float, ImageDims, 4 );
      callCorrectVectorDifferenceMacro( double, double, double, ImageDims, 4 );

      /** etcetera. */
    } // end support for vectors of length 4
    else
    {
