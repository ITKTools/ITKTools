...
*
*=========================================================================*/
#ifndef __itkFrangiVesselnessImageFilter_h
#define __itkFrangiVesselnessImageFilter_h
...
namespace itk
{
/** \class FrangiVesselnessImageFilter
...
class ITK_EXPORT FrangiVesselnessImageFilter :
  public UnaryFunctorImageFilter2< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef FrangiVesselnessImageFilter       Self;
  ...
  itkTypeMacro( FrangiVesselnessImageFilter, UnaryFunctorImageFilter2 );
  ...
  typedef FrangiVesselnessFunctor<
...
protected:
  ...
  virtual ~FrangiVesselnessImageFilter() {}

private:
  FrangiVesselnessImageFilter(const Self&); // purposely not implemented
  void operator=(const Self&);              // purposely not implemented

}; // end class FrangiVesselnessImageFilter
